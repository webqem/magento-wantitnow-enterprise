...
class Webqem_Mailcall_Block_Adminhtml_System_Config_Form_Field_Apitimeslots extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html = '<div id="apikey_condition__time_slot_template" style="display:none">';
        ...
        $html .= '<ul id="apikey_condition__time_slot_container">';
        ...
        $html .= '</ul>';
        $html .= $this->_getAddRowButtonHtml('apikey_condition__time_slot_container',
            'apikey_condition__time_slot_template', $this->__('Add New API KEY'));
